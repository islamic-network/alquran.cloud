...
<div class="row" id="surahConfigurator">
  ...
  <audio id="surahPlayer" controls="controls" class="">
    ...
    <source src="https://islamcdn.com/quran/media/audio/ayah/ar.alafasy/1/high" title="Bismillah" type="audio/mp3"/>
    <?php } ?>
    <?php foreach ($surah->data->ayahs as $ayah) { ?>
      <source src="https://islamcdn.com/quran/media/audio/ayah/ar.alafasy/<?= $ayah->number; ?>/high" title="<?= $surah->data->number; ?>_<?= $ayah->numberInSurah; ?>" type="audio/mp3"/>
    <?php } ?>
  </audio>
  </div>
</div>
